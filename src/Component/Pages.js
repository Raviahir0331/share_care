...
//   try {
//     await axios.post('http://localhost:5000/api/requestproducts', {productId,fullName,email});
  ...
  <div className='row'>
    {products.map(product => (
      <div className="col-md-4 " key={product._id}>
        ...
        <a href={`http://localhost:5000/${product.donationImage}`} className="img-hover" data-fancybox="gallery">
          <span className="icon icon-search"></span>
          <img src={`http://localhost:5000/${product.donationImage}`} alt={product.productName || "Image placeholder"} className="img-fluid "   />
        </a>
        </div>
        <button
...
<div class="card p-2 " style={{width: "18rem;"}} key={product._id}>
  <img src={`http://localhost:5000/${product.donationImage}`}  class="card-img-top" alt="..." />
  <div class="card-body  text-lg">
    <h5 class="card-title"><span className='text-blue-500'>ProductName</span>:  {product.productName}</h5>
    <p class="card-text"><span className='text-gray-600 font-serif'>Details</span>: {product.description}</p>
  </div>
            ...
            <div className="card shadow-sm" style={{ width: '100%' }}>
              ...
              {/* <div className="card-body">
                <h5 className="card-title">
                  <span className="text-primary">Product Name:</span> {product.productName}
                </h5>
